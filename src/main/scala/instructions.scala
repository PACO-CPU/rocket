...
object Instructions {
  ...
  def LUTL               = BitPat("b00?????00000?????????????0101011")
  def LUTE               = BitPat("b010????00000?????????????0101011")
  def LUTE2              = BitPat("b011??????????????????????0101011")
  def LUTW               = BitPat("b110????00000????????000000101011")
  def LUTW2              = BitPat("b111?????????????????000000101011")
  def LUTS               = BitPat("b10000??0000000000????????0101011")
  def ADD_APPROX         = BitPat("b??????0??????????000?????0001011")
  def SUB_APPROX         = BitPat("b??????0??????????001?????0001011")
  def MUL_APPROX         = BitPat("b??????0??????????010?????0001011") 
